...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS doichain doichaind doichain-node doichain-qt doichain-gui doichain-cli doichain-tx doichain-util doichain-wallet test_doichain bench_doichain)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET doichain AND TARGET doichain-qt AND TARGET doichaind AND TARGET doichain-cli AND TARGET doichain-tx AND TARGET doichain-wallet AND TARGET doichain-util AND TARGET test_doichain)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:doichain> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:doichain>
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:test_doichain> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:test_doichain>
...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET doichain-qt)
    set(macos_app "Doichain-Qt.app")
    # Populate Contents subdirectory.
    configure_file(${PROJECT_SOURCE_DIR}/share/qt/Info.plist.in ${macos_app}/Contents/Info.plist NO_SOURCE_PERMISSIONS)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/PkgInfo CONTENT "APPL????")
    # Populate Contents/Resources subdirectory.
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/empty.lproj CONTENT "")
    configure_file(${PROJECT_SOURCE_DIR}/src/qt/res/icons/doichain.icns ${macos_app}/Contents/Resources/doichain.icns NO_SOURCE_PERMISSIONS COPYONLY)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/Base.lproj/InfoPlist.strings
      CONTENT "{ CFBundleDisplayName = \"@CLIENT_NAME@\"; CFBundleName = \"@CLIENT_NAME@\"; }"
    )

    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Doichain-Qt
      ...
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:doichain-qt> ${macos_app}/Contents/MacOS/Doichain-Qt
    ...
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Doichain-Qt
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Doichain-Qt
      ...
      add_custom_target(deploydir
        DEPENDS ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Doichain-Qt
      )
