...
All three configurations assume several paths that might need to be adjusted.
    ...
    PID file:            /var/run/doichaind/doichaind.pid (OpenRC and Upstart) or
                         /run/doichaind/doichaind.pid (systemd)
...
Copy org.namecoin.doichaind.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/org.namecoin.doichaind.plist`.
...
You will need to modify org.namecoin.doichaind.plist if you intend to use it as a
