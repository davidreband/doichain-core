...
class CoinStatsIndexTest(BitcoinTestFramework):
    ...
    def _test_init_index_after_reorg(self):
        ...
        # something officially "supported" anyway).  The reorg/unclean-restart
        # section that used to live here is disabled on Doichain and was removed
        # to keep the dead-code linter happy; see git history to restore it.
