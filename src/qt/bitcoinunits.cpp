...
{
    switch (unit) {
    case Unit::BTC: return QString("DOI");
    case Unit::mBTC: return QString("mDOI");
    case Unit::uBTC: return QString::fromUtf8("µDOI");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Doichains");
    case Unit::mBTC: return QString("Milli-Doichains (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Doichains (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
